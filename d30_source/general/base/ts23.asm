...
*        4) MHINF
*        5) DIVISION IN EQU
*        JAN-2022 NEW MACROS TEST WITH EBX000=1 SET
*        6) DATE
**********************************************************************
         PGMID 'TS2301'
START    EQU   *-8
...
TS230100 EQU   *
         CLI   EBX000,1                 INPUT IS NEW PATH
         BE    TS231000                 YES - GO THERE
*
*        1) ALASC
*
         LHI   R1,1
...
*
TS231000 EQU   *
         DATE  PARS=R0,WORKAREA=ABC,SAVEREGS=YES,OK=EBW000,DOCUMENT=NO
TS23EXIT EQU   *
         EXITC
