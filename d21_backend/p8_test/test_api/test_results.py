...
from d21_backend.p8_test.test_api import api_post, api_delete, api_get
...
class TestResults(TestCase):
    ...
    def test_happy_path(self):
        ...
        # self.assertEqual(" 15765:$$CN_PGM_START.5:ENTNC:[('ETK7', None)]", result.last_node)           # Listing LXP
        self.assertEqual("   228:$$CN_PGM_START.5:ENTNC:[('ETK7', None)]", result.last_node)  # Assembler
