...
from d21_backend.p1_utils.errors import RegisterInvalidError, ConditionMaskError, NotFoundInSymbolTableError, AssemblyError
...
class BranchCondition(unittest.TestCase):
    def test_branch_condition(self):
        ...
        self.assertRaises(AssemblyError, seg.branch_condition, Line.from_line(" BC TS060100"))
