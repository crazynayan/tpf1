...
from d21_backend.p2_assembly.mac2_data_macro import get_global_ref
from d21_backend.p3_db.response import StandardResponse
from d21_backend.p3_db.template_models import Template, PNR, GLOBAL, AAA, AAA_MACRO_NAME, validate_ownership
