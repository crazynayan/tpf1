...
class NonConditional1(unittest.TestCase):
    ...
    def test_ts14(self):
        ...
        self.assertEqual('C1C1', self.aaa['WA0BBR'].hex)
        self.assertEqual('00000000C1C1', self.aaa['WA0QHR'].hex)
        self.assertEqual(2, self.output.regs['R3'])
        self.assertEqual('02', self.aaa['WA0TKK'].hex)
        ...
        self.assertEqual('02', self.ecb['EBW000'].hex)
        self.assertEqual('40' * 6, self.ecb['EBW001'].hex)
        self.assertEqual('00' * 6, self.ecb['EBW008'].hex)
        ...
        self.assertEqual('42', self.ecb['EBW016'].hex)
        self.assertEqual('40', self.ecb['EBW017'].hex)
        self.assertEqual(f"{macros['WA0AA'].evaluate('#WA0GEN'):02X}", self.aaa['WA0TY1'].hex)
        ...
        self.assertEqual(f"{0xFF - macros['WA0AA'].evaluate('#WA0GEN'):02X}", self.ecb['EBW018'].hex)
