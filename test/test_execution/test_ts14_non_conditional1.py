...
class NonConditional1(unittest.TestCase):
    ...
    def test_ts14(self):
        self.state.run('TS14')
        aaa = self.state.regs.R1
        self.assertEqual(0xFFFFC1C1 - 0x100000000, self.state.regs.R2)
        ...
        self.assertEqual(2, self.state.regs.R5)
        self.assertEqual(-2, self.state.regs.R6)
        self.assertEqual(4, self.state.regs.R7)
        self.assertEqual(2, self.state.regs.R10)
        self.assertEqual(0x00000100, self.state.regs.R4)
        self.assertEqual(0x00000000, self.state.regs.R11)
        self.assertEqual(-1, self.state.regs.R12)
        self.assertEqual(aaa + 0x03F, self.state.regs.R13)
        self.assertEqual(aaa + 0x041, self.state.regs.R14)
        self.assertEqual(5, self.state.regs.R15)
