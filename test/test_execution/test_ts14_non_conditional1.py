...
class NonConditional1(unittest.TestCase):
    ...
    def test_ts14(self):
        ...
        self.assertEqual('C1C1', test_data.field('WA0BBR'))
        self.assertEqual('00000000C1C1', test_data.field('WA0QHR'))
        self.assertEqual(2, test_data.output.regs['R3'])
        self.assertEqual('02', test_data.field('WA0TKK'))
        ...
        self.assertEqual('02', test_data.field('EBW000'))
        self.assertEqual('40' * 6, test_data.field('EBW001'))
        self.assertEqual('00' * 6, test_data.field('EBW008'))
        ...
        self.assertEqual('42', test_data.field('EBW016'))
        self.assertEqual('40', test_data.field('EBW017'))
        self.assertEqual(f"{macros['WA0AA'].evaluate('#WA0GEN'):02X}", test_data.field('WA0TY1'))
