...
class NonConditional2(unittest.TestCase):
    ...
    def test_ts15(self):
        ...
        self.assertEqual('00000017', self.test_data.hex(self.ecb['EBW000']['data']))
        self.assertEqual(-2, self.output.regs['R3'])
        self.assertEqual('FF00', self.test_data.hex(self.ecb['EBW004']['data']))
        ...
        self.assertEqual('40404040C140404040C14040', self.test_data.hex(self.ecb['EBW008']['data']))
        self.assertEqual('40404040C140404040C14040', self.test_data.hex(self.ecb['EBW020']['data']))
        self.assertEqual('000000000002048C', self.test_data.hex(self.ecb['EBW040']['data']))
        self.assertEqual(2048, self.output.regs['R4'])
        self.assertEqual('000000000012048C', self.test_data.hex(self.ecb['EBW048']['data']))
        self.assertEqual(12048, self.output.regs['R5'])
        self.assertEqual(14096, self.output.regs['R6'])
        self.assertEqual('000000000014096C', self.test_data.hex(self.ecb['EBW056']['data']))
        self.assertEqual('F0F1F4F0F9C6', self.test_data.hex(self.ecb['EBW032']['data']))
        self.assertEqual('F0F1F4F0F9F6', self.test_data.hex(self.ecb['EBW064']['data']))
