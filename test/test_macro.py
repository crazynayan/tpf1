...
class MacroTest(unittest.TestCase):
    ...
    def test_TR1GAA(self):
        ...
        # self.assertEqual(46, self.macro.symbol_table['TR1G_40_ATPCOTI_EXP'].dsp)
        ...
        # self.assertEqual(0x71, self.macro.symbol_table['#TR1G_40_CI_DSP'].dsp)
        # self.assertEqual(16, self.macro.symbol_table['TR1G_40_TRLVLIND'].length)
        # self.assertEqual(0x77, self.macro.symbol_table['TR1G_40_TRLVLIND'].dsp)
        ...
        # self.assertEqual(86, self.macro.symbol_table['#TR1G_40_PRIO_BAG'].dsp)
        ...
        # self.assertEqual(0xAD, self.macro.symbol_table['#TR1G_40_ACS_ENTLMNT@CG1'].dsp)
        # self.assertEqual(0xAD, self.macro.symbol_table['#TR1G_40_ACS_SKY_PRTY_TIER@CG1'].dsp)
