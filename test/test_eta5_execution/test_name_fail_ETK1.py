...
class NameFailETK1(NameGeneral):
    ...
    def test_no_name_tty_ETK1_33(self) -> None:
        ...
        self.assertEqual('00', self.test_data.hex(self.o_ui2['UI2CNN']['data']))
    ...
    def test_multiple_groups_CZ_tty_ETK1_16(self):
        ...
        self.assertEqual('E0', self.test_data.hex(self.o_ecb['EBRS01']['data']))
        self.assertEqual('C3', self.test_data.hex(self.o_ecb['EBW014']['data']))
    ...
    def test_invalid_type_ETK1_16(self):
        ...
        self.assertEqual(16, self.output.regs['R6'])
        self.assertEqual('E0', self.test_data.hex(self.o_ecb['EBRS01']['data']))
        self.assertEqual('D2', self.test_data.hex(self.o_ecb['EBW014']['data']))
    ...
    def test_group_Z_not_at_start_ETK1_16(self):
        ...
        self.assertEqual(16, self.output.regs['R6'])
        self.assertEqual('E0', self.test_data.hex(self.o_ecb['EBRS01']['data']))
        self.assertEqual('00', self.test_data.hex(self.o_ecb['EBW014']['data']))
