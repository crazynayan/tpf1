...
class Sub1Test(unittest.TestCase):
    ...
    def test_b4t0(self):
        ...
        self.assertEqual('B4T0 ', DataType('X', input=test_data.field('EBX003')).decode)
        self.assertEqual('C2F4E3', test_data.field('EBX000'))
        self.assertEqual('00017F', test_data.field('EBX008'))
    ...
    def test_b4t1(self):
        ...
        self.assertEqual('TS22EXIT.1', test_data.output.last_line)
        self.assertEqual(0, test_data.output.regs['R0'])
        self.assertEqual('B4T1 ', DataType('X', input=test_data.field('EBX003')).decode)
        self.assertEqual('006F2F', test_data.field('EBX000'))
        self.assertEqual('006F2F', test_data.field('EBX008'))
    ...
    def test_A0B_encode(self):
        ...
        self.assertEqual('TS22EXIT.1', test_data.output.last_line)
        self.assertEqual(0, test_data.output.regs['R0'])
        self.assertEqual('A0B0 ', DataType('X', input=test_data.field('EBX003')).decode)
        self.assertEqual('C1F0C2', test_data.field('EBX000'))
        self.assertEqual('000001', test_data.field('EBX008'))
    ...
    def test_A1B1(self):
        ...
        self.assertEqual('TS22EXIT.1', test_data.output.last_line)
        self.assertEqual(0, test_data.output.regs['R0'])
        self.assertEqual('A1B1 ', DataType('X', input=test_data.field('EBX003')).decode)
        self.assertEqual('006DCB', test_data.field('EBX000'))
        self.assertEqual('006DCB', test_data.field('EBX008'))
    ...
    def test_DP83(self):
        ...
        self.assertEqual('TS22EXIT.1', test_data.output.last_line)
        self.assertEqual(0, test_data.output.regs['R0'])
        self.assertEqual('DP83 ', DataType('X', input=test_data.field('EBX003')).decode)
        self.assertEqual('01714A', test_data.field('EBX000'))
        self.assertEqual('01714A', test_data.field('EBX008'))
    ...
    def test_23Y7(self):
        ...
        self.assertEqual('TS22EXIT.1', test_data.output.last_line)
        self.assertEqual(0, test_data.output.regs['R0'])
        self.assertEqual('23Y7 ', DataType('X', input=test_data.field('EBX003')).decode)
        self.assertEqual('0365C6', test_data.field('EBX000'))
        self.assertEqual('0365C6', test_data.field('EBX008'))
    ...
    def test_4K37(self):
        ...
        self.assertEqual('TS22EXIT.1', test_data.output.last_line)
        self.assertEqual(0, test_data.output.regs['R0'])
        self.assertEqual('4K37 ', DataType('X', input=test_data.field('EBX003')).decode)
        self.assertEqual('035DA7', test_data.field('EBX000'))
        self.assertEqual('035DA7', test_data.field('EBX008'))
