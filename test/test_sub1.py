...
class Sub1Test(unittest.TestCase):
    ...
    def test_b4t0(self):
        ...
        self.assertEqual('B4T0 ', DataType('X', input=self.test_data.hex(self.o_ecb['EBX003']['data'])).decode)
        self.assertEqual('C2F4E3', self.test_data.hex(self.o_ecb['EBX000']['data']))
        self.assertEqual('00017F', self.test_data.hex(self.o_ecb['EBX008']['data']))
    ...
    def test_b4t1(self):
        ...
        self.assertEqual('TS22EXIT.1', self.output.last_line)
        self.assertEqual(0, self.output.regs['R0'])
        self.assertEqual('B4T1 ', DataType('X', input=self.test_data.hex(self.o_ecb['EBX003']['data'])).decode)
        self.assertEqual('006F2F', self.test_data.hex(self.o_ecb['EBX000']['data']))
        self.assertEqual('006F2F', self.test_data.hex(self.o_ecb['EBX008']['data']))
    ...
    def test_A0B_encode(self):
        ...
        self.assertEqual('TS22EXIT.1', self.output.last_line)
        self.assertEqual(0, self.output.regs['R0'])
        self.assertEqual('A0B0 ', DataType('X', input=self.test_data.hex(self.o_ecb['EBX003']['data'])).decode)
        self.assertEqual('C1F0C2', self.test_data.hex(self.o_ecb['EBX000']['data']))
        self.assertEqual('000001', self.test_data.hex(self.o_ecb['EBX008']['data']))
    ...
    def test_A1B1(self):
        ...
        self.assertEqual('TS22EXIT.1', self.output.last_line)
        self.assertEqual(0, self.output.regs['R0'])
        self.assertEqual('A1B1 ', DataType('X', input=self.test_data.hex(self.o_ecb['EBX003']['data'])).decode)
        self.assertEqual('006DCB', self.test_data.hex(self.o_ecb['EBX000']['data']))
        self.assertEqual('006DCB', self.test_data.hex(self.o_ecb['EBX008']['data']))
    ...
    def test_DP83(self):
        ...
        self.assertEqual('TS22EXIT.1', self.output.last_line)
        self.assertEqual(0, self.output.regs['R0'])
        self.assertEqual('DP83 ', DataType('X', input=self.test_data.hex(self.o_ecb['EBX003']['data'])).decode)
        self.assertEqual('01714A', self.test_data.hex(self.o_ecb['EBX000']['data']))
        self.assertEqual('01714A', self.test_data.hex(self.o_ecb['EBX008']['data']))
    ...
    def test_23Y7(self):
        ...
        self.assertEqual('TS22EXIT.1', self.output.last_line)
        self.assertEqual(0, self.output.regs['R0'])
        self.assertEqual('23Y7 ', DataType('X', input=self.test_data.hex(self.o_ecb['EBX003']['data'])).decode)
        self.assertEqual('0365C6', self.test_data.hex(self.o_ecb['EBX000']['data']))
        self.assertEqual('0365C6', self.test_data.hex(self.o_ecb['EBX008']['data']))
    ...
    def test_4K37(self):
        ...
        self.assertEqual('TS22EXIT.1', self.output.last_line)
        self.assertEqual(0, self.output.regs['R0'])
        self.assertEqual('4K37 ', DataType('X', input=self.test_data.hex(self.o_ecb['EBX003']['data'])).decode)
        self.assertEqual('035DA7', self.test_data.hex(self.o_ecb['EBX000']['data']))
        self.assertEqual('035DA7', self.test_data.hex(self.o_ecb['EBX008']['data']))
