...
class Dsect(unittest.TestCase):
    def test_dsect(self):
        ...
        self.assertEqual('R14', seg.nodes['$$TS08$$.4'].field_len.base.reg)
        self.assertEqual(1, seg.nodes['$$TS08$$.4'].field_len.length)
        self.assertEqual('R8', seg.nodes['$$TS08$$.4'].field.base.reg)
        self.assertEqual(60, seg.nodes['$$TS08$$.4'].field.dsp)
