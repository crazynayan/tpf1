...
class Subroutine(unittest.TestCase):
    def test_subroutine(self):
        ...
        # AHI   R2,1
        self.assertEqual('AHI', seg.nodes['TS09S100.2'].command)
        # LTR   R1,R1
        self.assertEqual('LTR', seg.nodes['TS09S100.3'].command)
        # NOPR  0
        node = seg.nodes['TS09S100.4']
        ...
        # AHI   R2,1
        self.assertEqual('AHI', seg.nodes['TS09S100.5'].command)
        # BR    R4
        node = seg.nodes['TS09S100.6']
